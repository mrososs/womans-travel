...
const reasonText = computed(() => {
  const map: Record<string, string> = {
    ...
    cancelled: 'تم إلغاء عملية الدفع قبل إتمامها. لم يتم خصم أي مبلغ.',
    rejected: 'لم تتم الموافقة على التقسيط عبر تابي لهذا الطلب. يمكنكِ الدفع بالبطاقة أو التحويل البنكي.',
    expired: 'انتهت صلاحية جلسة الدفع. يُرجى المحاولة من جديد.',
  };
